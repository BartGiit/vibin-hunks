...
export const Creators = () => {
  ...
  return (
    <div className="Creators">
      ...
      <div className="Cards">
        <SingleCreator s1={"-"} s2={""} num={4} key={1} rotation="4deg" signature="Michael" title="Artist" description="Benchpress 220lbs, Project concept, 3D graphics, 3D animation" />
        <SingleCreator s1={""} s2={"-"} num={7} key={2} rotation="-2deg" signature="Nick" title="Marketing" description="Squats 440lbs, Project concept, SMM" />
