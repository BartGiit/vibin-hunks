  ...
  return (
    <div className={"SocialMedia"}>
      ...
      <div className="Image">
        ...
        <div className='Angel'>
          {Mobile ? <video autoPlay loop muted playsInline poster={require('../../../src/images/socialMedia/amor.jpeg')}><source src={require("../../../src/images/socialMedia/amor_mobile.mp4")} type='video/mp4'/></video> : <video autoPlay loop muted playsInline><source src={require("../../../src/images/socialMedia/amor.mp4")} type='video/mp4; codecs="hvc1"'/><source src={require("../../../src/images/socialMedia/amor.webm")} type='video/webm'/></video> }
        </div>
      </div>
    </div>
  );
